...
class PAIUtteranceMixingDataset(FairseqDataset):
    ...
    def batch_by_size(self, indices, max_tokens=None, max_sentences=None, required_batch_size_multiple=1):
        ...
        logger.info(f"isinstance(indices[0], list) ? {isinstance(indices[0], list)} {indices[0]}")
        if isinstance(indices[0], list):
            ...
            return super(PAIUtteranceMixingDataset, self).batch_by_size(indices, max_tokens, max_sentences, required_batch_size_multiple)
